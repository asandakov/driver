...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    public lazy var applicationCoordinator: BaseCoordinator = self.createCoordinator()
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
       ...
       window?.rootViewController = self.rootController
        ...
        print(Unmanaged.passUnretained(applicationCoordinator).toOpaque())
...
//        window?.makeKeyAndVisible()
    ...
    private func createCoordinator() -> BaseCoordinator {
